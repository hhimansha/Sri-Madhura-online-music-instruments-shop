    ...
    <nav className="bg-white border-gray-200 text-gray-900 shadow-lg">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-1">
        ...
        <div className="flex items-center md:order-2 space-x-3 md:space-x-3 rtl:space-x-reverse relative">
          <button type="button" className="px-4 py-1 mx-6 text-20 text-orange bg- font-semibold rounded-lg border border-grey transition duration-1000 ease-in-out bg-gray-900 text-white hover:text-white hover:bg-primary">Log In</button>
          ...
          <div className={`z-50 absolute right-0 top-full mt-1 ${showDropdown ? "block animate-fade-in" : "hidden"} text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-lg`} id="user-dropdown" ref={dropdownRef}>
            ...
            <ul className="py-2 font-medium" aria-labelledby="user-menu-button">
              <li><a href="dash" className="block px-4 py-2 text-sm text-gray-700 hover:text-primary">Dashboard</a></li>
              <li><a href="set" className="block px-4 py-2 text-sm text-gray-700 hover:text-primary">Settings</a></li>
              <li><a href="ear" className="block px-4 py-2 text-sm text-gray-700 hover:text-primary">Earnings</a></li>
              <li><a href="sout" className="block px-4 py-2 text-sm text-red-500">Sign out</a></li>
            </ul>
          </div>
        ...
        <div className={`items-center justify-between ${showMenu ? "" : "hidden"} w-full md:flex md:w-auto md:order-1`} id="navbar-user" ref={categoryDropdownRef}>
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-6 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
            ...
            <li><a href="#" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:p-0 dark:text-gray-900 md:dark:hover:text-primary">Home</a></li>
            <li>
              {/* categories section (dropdown)*/}
              <button onClick={toggleCategoryDropdown} className="flex items-center justify-between w-full py-2 px-3 text-gray-900 rounded md:w-auto md:hover:bg-transparent md:border-0 md:hover:text-primary md:p-0 ">Categories <svg className="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4"/></svg></button>
              {/* dropdown list of the Categories*/}
              <div className={`absolute right-0 left-0 mt-3 ${showCategoryDropdown ? "block animate-fade-in" : "hidden"} bg-white divide-y divide-gray-100 shadow-lg dark:divide-gray-600`} id="mega-menu-full-dropdown">
                <div class="grid max-w-screen-md px-4 py-5 mx-auto text-gray-900 sm:grid-cols-2 md:px-6">
                  <ul>
                    <div class="justify-start">
                      {/* main category Western*/}
                      <button type="button" class=" group inline-flex w-fit items-center justify-left rounded-lg pl-2 py-4 text-lg font-semibold text-black transition-all duration-200 ease-in-out focus:shadow hover:bg-grey">Western<svg xmlns="http://www.w3.org/2000/svg" class="group-hover:ml-8 ml-4 h-6 w-6 transition-all" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6"/></svg></button>
                    </div>
                    {/* sub categories*/}
                  ...
                  <ul>
                    <div class="justify-start">
                      ...
                      <button type="button" class=" group inline-flex w-fit items-center justify-left rounded-lg pl-2 py-4 text-lg font-semibold text-black transition-all duration-200 ease-in-out focus:shadow hover:bg-grey">Eastern<svg xmlns="http://www.w3.org/2000/svg" class="group-hover:ml-8 ml-4 h-6 w-6 transition-all" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6"/></svg></button>
                    </div>
                    {/* sub categories*/}
