...
//     setLoading(true);
//     axios
//       .get(`http://localhost:3000/prices/${id}`)
//       .then((response) => {
...
//     setLoading(true);
//     axios
//       .put(`http://localhost:3000/prices/${id}`, data)
//       .then(() => {
//         setLoading(false);
...
//     <div className='p-4'>
//       <BackButton />
//       <h1 className='text-3xl my-4'>Edit Detail</h1>
//       {loading ? <Spinner /> : ''}
...
//         <button className='p-2 bg-sky-300 m-8' onClick={handleEditPrice}>
//           Save
//         </button>
//       </div>
//     </div>
